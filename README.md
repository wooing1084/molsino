...
메뉴에서 블랙잭을 선택합니다. 바카라는 준비 중입니다. 판을 마치면 메뉴로 돌아갈 수 있고, 메뉴의 새 시작에서 전체 잔액과 기록을 초기화합니다. 초기 잔액은 $100입니다. `−/+` 또는 금액칸을 눌러 베팅을 정하고 딜한 뒤, 화면에 표시되는 합법 행동으로 히트·스탠드·더블·스플릿·서렌더와 보험·이븐 머니를 플레이할 수 있습니다.
